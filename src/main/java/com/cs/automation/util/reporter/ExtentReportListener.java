...
//		for (String step : Reporter.getOutput(result)) 
//			addStepToExtentReport(step);
		// commented below screenshot capture as we already taking screenshot on verify fail
        ...
        if (method.isTestMethod()) {
            ...
            if (verificationFailures.size() != 0) {
                ...
                if (size == 1) {
                    ...
                    StringBuffer failureMessage = new StringBuffer("Multiple failures (").append(
                            size).append("):nn");
                    ...
                    failureMessage.append("Failure ").append(size).append(" of ").append(size)
                            .append(":n");
